...
class DestinationsControllerTest < ActionController::TestCase
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post :create, destination: { address: @destination.address, end: @destination.end, itinerary_id: @destination.itinerary_id, lat: @destination.lat, long: @destination.long, start: @destination.start }
    end
  ...
  test "should update destination" do
    put :update, id: @destination, destination: { address: @destination.address, end: @destination.end, itinerary_id: @destination.itinerary_id, lat: @destination.lat, long: @destination.long, start: @destination.start }
    assert_redirected_to destination_path(assigns(:destination))
  end
