...
class ItinerariesControllerTest < ActionController::TestCase
  ...
  test "should create itinerary" do
    assert_difference('Itinerary.count') do
      post :create, itinerary: { end: @itinerary.end, name: @itinerary.name, start: @itinerary.start, user_id: @itinerary.user_id }
    end
  ...
  test "should update itinerary" do
    put :update, id: @itinerary, itinerary: { end: @itinerary.end, name: @itinerary.name, start: @itinerary.start, user_id: @itinerary.user_id }
    assert_redirected_to itinerary_path(assigns(:itinerary))
  end
